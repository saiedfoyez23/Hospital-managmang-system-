        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    string Updatequery = "update REGISTRATION set GENDER=:gender,PHONE=:phone,TIME=:time,ADDRESS=:address,DISEASE=:disease,STATUS=:status,PRICE=:price where PID=:pid";
