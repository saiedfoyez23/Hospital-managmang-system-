...
{
    public partial class PatiantRegistration : Form
    {
        public PatiantRegistration()
        {
            InitializeComponent();
        }
        ...
        private void PatiantRegistration_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
