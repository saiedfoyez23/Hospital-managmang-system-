...
namespace Hospital_Managment_System.Patient
{
    public partial class PatientInformation : Form
    {
        ...
        private void rEGISTRATIONDataGridView_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            textBox8.Text = rEGISTRATIONDataGridView.Rows[e.RowIndex].Cells[12].Value.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    string Updatequery = "update REGISTRATION set GENDER=:gender,PHONE=:phone,ADDRESS=:address,DISEASE=:disease,STATUS=:status,PRICE=:price,Time=:time where PID=:pid";
                    ...
                    cmd.Parameters.Add(new OracleParameter("time", OracleDbType.Varchar2, textBox8.Text, ParameterDirection.Input));
        ...
        private void textBox13_TextChanged(object sender, EventArgs e)
        {
            ...
            OracleConnection con = new OracleConnection(oradb);
            con.Open();
            OracleDataAdapter adebtar = new OracleDataAdapter("select * from REGISTRATION where NAME like '" + textBox13.Text + "%'", con);
