...
namespace Hospital_Managment_System {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class STAFFDataTable : global::System.Data.TypedTableBase<STAFFRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public STAFFRow AddSTAFFRow(decimal ID, string NAME, string SEX, string POSITION, decimal SALARY, decimal PHONE, string ADDRESS) {
...
namespace Hospital_Managment_System.DataSet3TableAdapters {
    ...
    public partial class STAFFTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""STUDENT"".""STAFF"" WHERE ((""ID"" = :Original_ID) AND ((:IsNull_NAME = 1 AND ""NAME"" IS NULL) OR (""NAME"" = :Original_NAME)) AND ((:IsNull_SEX = 1 AND ""SEX"" IS NULL) OR (""SEX"" = :Original_SEX)) AND ((:IsNull_POSITION = 1 AND ""POSITION"" IS NULL) OR (""POSITION"" = :Original_POSITION)) AND ((:IsNull_SALARY = 1 AND ""SALARY"" IS NULL) OR (""SALARY"" = :Original_SALARY)) AND ((:IsNull_PHONE = 1 AND ""PHONE"" IS NULL) OR (""PHONE"" = :Original_PHONE)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"STUDENT\".\"STAFF\" (\"ID\", \"NAME\", \"SEX\", \"POSITION\", \"SALARY\", \"PHONE\"" +
                ", \"ADDRESS\") VALUES (:ID, :NAME, :SEX, :POSITION, :SALARY, :PHONE, :ADDRESS)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""STUDENT"".""STAFF"" SET ""ID"" = :ID, ""NAME"" = :NAME, ""SEX"" = :SEX, ""POSITION"" = :POSITION, ""SALARY"" = :SALARY, ""PHONE"" = :PHONE, ""ADDRESS"" = :ADDRESS WHERE ((""ID"" = :Original_ID) AND ((:IsNull_NAME = 1 AND ""NAME"" IS NULL) OR (""NAME"" = :Original_NAME)) AND ((:IsNull_SEX = 1 AND ""SEX"" IS NULL) OR (""SEX"" = :Original_SEX)) AND ((:IsNull_POSITION = 1 AND ""POSITION"" IS NULL) OR (""POSITION"" = :Original_POSITION)) AND ((:IsNull_SALARY = 1 AND ""SALARY"" IS NULL) OR (""SALARY"" = :Original_SALARY)) AND ((:IsNull_PHONE = 1 AND ""PHONE"" IS NULL) OR (""PHONE"" = :Original_PHONE)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, \"NAME\", SEX, POSITION, SALARY, PHONE, ADDRESS FROM STUDENT.STAFF";
        ...
        public virtual int Delete(decimal Original_ID, string Original_NAME, string Original_SEX, string Original_POSITION, global::System.Nullable<decimal> Original_SALARY, global::System.Nullable<decimal> Original_PHONE, string Original_ADDRESS) {
        ...
        public virtual int Insert(decimal ID, string NAME, string SEX, string POSITION, global::System.Nullable<decimal> SALARY, global::System.Nullable<decimal> PHONE, string ADDRESS) {
        ...
        public virtual int Update(decimal ID, string NAME, string SEX, string POSITION, global::System.Nullable<decimal> SALARY, global::System.Nullable<decimal> PHONE, string ADDRESS, decimal Original_ID, string Original_NAME, string Original_SEX, string Original_POSITION, global::System.Nullable<decimal> Original_SALARY, global::System.Nullable<decimal> Original_PHONE, string Original_ADDRESS) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NAME, string SEX, string POSITION, global::System.Nullable<decimal> SALARY, global::System.Nullable<decimal> PHONE, string ADDRESS, decimal Original_ID, string Original_NAME, string Original_SEX, string Original_POSITION, global::System.Nullable<decimal> Original_SALARY, global::System.Nullable<decimal> Original_PHONE, string Original_ADDRESS) {
            return this.Update(Original_ID, NAME, SEX, POSITION, SALARY, PHONE, ADDRESS, Original_ID, Original_NAME, Original_SEX, Original_POSITION, Original_SALARY, Original_PHONE, Original_ADDRESS);
        }
    }
